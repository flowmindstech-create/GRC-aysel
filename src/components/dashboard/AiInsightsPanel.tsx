  ...
  return (
    <div className="card p-5">
      <div className="flex items-center gap-2 mb-5">
        <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-sky-500">
        ...
        <span className="ml-auto text-[10px] px-2 py-0.5 rounded-full bg-sky-500/15 text-sky-500 font-medium">
          Live
        </span>
      </div>
      ...
      <button className="w-full mt-4 py-2 text-xs font-medium text-sky-500 hover:text-sky-400 transition-colors border border-sky-500/20 rounded-lg hover:bg-sky-500/5">
